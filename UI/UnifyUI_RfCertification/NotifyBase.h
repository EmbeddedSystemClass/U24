...
#define _TC(x) "x"
	...
	typedef vector<NotifyFuncData_Char> INotifyPoolCh;
	typedef vector<NotifyFuncData_Char>::iterator INotifyPoolChIter;
	typedef map<std::string,INotifyPoolCh> NotifyMapCh;	
	typedef map<std::string,INotifyPoolCh>::iterator NotifyMapChIter;
	typedef pair<std::string,INotifyPoolCh> NotifyMapChPair;
