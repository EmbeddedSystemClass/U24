...
// CRFCertificationRx dialog

class CRFCertificationRx : public CDialog
{
	DECLARE_DYNAMIC(CRFCertificationRx)

public:
	CRFCertificationRx(CWnd* pParent = NULL);   // standard constructor
	virtual ~CRFCertificationRx();

// Dialog Data
	enum { IDD = IDD_SERVICE_SUBUI_WIFI_RX };
