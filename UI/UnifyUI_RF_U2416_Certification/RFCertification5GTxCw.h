...
class CRFCertification5GTxCw : public CDialog
{
	DECLARE_DYNAMIC(CRFCertification5GTxCw)

public:
	CRFCertification5GTxCw(CWnd* pParent = NULL);   // standard constructor
	virtual ~CRFCertification5GTxCw();

// Dialog Data
	enum { IDD = IDD_SERVICE_SUBUI_5G_TX_CW };
