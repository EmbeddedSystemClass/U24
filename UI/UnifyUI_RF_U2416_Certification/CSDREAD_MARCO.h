...
class CCSDREAD_MARCO : public CDialog
{
	DECLARE_DYNAMIC(CCSDREAD_MARCO)

public:
	CCSDREAD_MARCO(CWnd* pParent = NULL);   // standard constructor
	virtual ~CCSDREAD_MARCO();

// Dialog Data
	enum { IDD = IDD_SERVICE_SUBUI_CSDREAD_Marco };
