...
class CRFCertificationTx : public CDialog
{
	DECLARE_DYNAMIC(CRFCertificationTx)

public:
	CRFCertificationTx(CWnd* pParent = NULL);   // standard constructor
	virtual ~CRFCertificationTx();
