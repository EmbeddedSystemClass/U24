...
Program: QMSL
	...
	$Id: //depot/HTE/QDART/QMSL6/inc/QMSL_AP/QMSL_FTM_AP.h#2 $1 $
...
extern "C" {
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_AP_TEST_APP_STATUS ( HANDLE hResourceContext, unsigned short* iFTM_Error_Code, unsigned char* iState, unsigned char* iFail_Count);
   /******************************************************************************/
   /**
