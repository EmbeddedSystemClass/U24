...
Program: QMSL_NFC
	...
	$Id: //depot/HTE/QDART/QMSL6/inc/QMSL_Connectivity/QMSL_Connectivity_NFC/QMSL_Connectivity_NFC.h#9 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \param piErrorCode = returns code to identify the type of error that may have occured
   	...
   	\endcode
   \param piErrorLineNum = if there was a file parsing error, this identifies the line number in the file
