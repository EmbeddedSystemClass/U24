/******************************************************************************
 * $File: //depot/HTE/QDART/QMSL6/inc/QMSL_Diag/QMSL_Diag.h $
 *
 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_Diag/QMSL_Diag.h#8 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   /** see Call Manager ICD 3.4.50 Call Origination request
       ...
       response message does not guarantee a successful call origination. The phone call processing
   ...
   *******************************************************************************/
   ...
   /**
      ...
      mask.
      Event Mask is a byte array where each bit denotes an event ID configuration. A bit value of 1
