/******************************************************************************
 * $File: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_WCDMA_NS.h $
 *
 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_WCDMA_NS.h#2 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \param aiMemPartitionInfo[8] Array of 8 bytes that represent the number of soft bits to define for each HARQ
                                 ...
                                 can be don care values. Each valid element should take on one of the
                                 following values:
      \code
         ...
         HARQ processes 0-2, and X is don care value.
      \endcode
   ...
   *******************************************************************************/
   ...
   The UE will send a BER log packet every time it has processed FramesPerLog?number of received data blocks.
   ...
   *******************************************************************************/
   ...
   should be ??  If the test box does not conform, this field should be 0.
   \endcode
