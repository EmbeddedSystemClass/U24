/******************************************************************************
 * $File: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_LTE_NS.h $
 *
 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_LTE_NS.h#5 $
 * $DateTime: 2014/02/10 16:46:09 $
 *
 */
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NS_HANDOVER( HANDLE hResourceContext, unsigned char iBand, unsigned short iEARFCN, unsigned long* pStatus );
   ...
   *******************************************************************************/
   ...
   \return
    ...
    \note This function can be used in QMSL FTM Sequencer operation
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_LTE_NS_ENABLE_SCELL( HANDLE hResourceContext, unsigned char iBand, unsigned short iEARFCN, unsigned long* pStatus );
