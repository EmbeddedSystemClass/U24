...
$Id: //depot/HTE/QDART/QMSL/QLib_Defines.h#454 $
...
typedef struct
{
   ...
   */
   ...
   FTM2LogMessage_TDSCDMA_RxAGC oTDSCDMA_TxAGC;
...
typedef struct
{
   ...
   //! Desired power level for HDET Offset calculation (usually 18 dBm) [AJ] -> Should be 26dBm
   double HDET_SpanPower_dBm;

   //! Desired power level for HDET Span calculation (usually 26 dBm) [AJ] -> Should be 18dBm
   double HDET_OffsetPower_dBm;
