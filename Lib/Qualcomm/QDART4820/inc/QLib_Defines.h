...
$Id: //depot/HTE/QDART/QMSL6/QLib_Defines.h#274 $
...
FTM_ENH_INTERNAL_DEVICE_CAL_RSB_RES_MAX = 5 
...
{
  uint8 device_mask;
  ftm_rsb_result_data_type rsb_res[FTM_ENH_INTERNAL_DEVICE_CAL_RSB_RES_MAX];
