...
Program: QMSL
   ...
   $Id: //depot/HTE/QDART/QMSL6/inc/QMSL_SWDownload/QMSL_QPHONEMS_SWDL.h#30 $
...
extern "C" {
  ...
  *******************************************************************************/
   ...
   *******************************************************************************/
   ...
   /*****************************************************************************/
   /**
   This method will download a single the images file when the device is in FireHose mode.
   ...
   *******************************************************************************/
   ...
   \param msmid = MSMID which will be got from device, it only works when bGetMsmid is non-zero
   ...
   \param mode = Sahara hello Packet mode, when mode = 0, this indicates a SAHARA_MODE_IMAGE_TX_PENDING mode
	...
	\param bGetMsmid = Whether get the MSMID or not
