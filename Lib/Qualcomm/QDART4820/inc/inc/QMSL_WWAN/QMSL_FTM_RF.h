 ...
 ******************************************************************************
 *
* $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_RF.h#52 $
* $DateTime: 2014/04/10 11:04:55 $
 *
 */
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   WCDMA: This command turns on the phone transmit chain (including the PA) and causes a WCDMA
   uplink waveform or CW to be generated on the current channel. All necessary encoder hardware
   initialization for transmitting is handled by this function.


   GSM:This command turns on the phone transmit chain (including the PA) and causes a GSM uplink
   ...
   *******************************************************************************/
   ...
   This command turns off the phone transmit chain.
   ...
   *******************************************************************************/
   ...
   \param Results = Number of bytes in the results field is variable and is defined 
                    by ayload Size? The results will follow the sequence of bits 
                    enabled in elect_rx_chain?field starting with least significant 
                    bit.
   ...
   *******************************************************************************/
   ...
   \param Centre_Freq_Hz = Tx carrier frequency for current cellular band/channel, in Hz units
  ...
  ******************************************************************************/
   ...
   QLIB_API unsigned char QLIB_FTM_SET_FBRX_PATH(HANDLE hResourceContext, void* enh_internal_device_cal);
    ...
    /**
   QLIB_RFCAL_Generate_FBRX_DC_NV writes the FBRx DC Cal results to the NV structure  .
  

  ******************************************************************************/
   unsigned char QLIB_RFCAL_Generate_FBRX_DC_NV(	HANDLE hResourceContext,
