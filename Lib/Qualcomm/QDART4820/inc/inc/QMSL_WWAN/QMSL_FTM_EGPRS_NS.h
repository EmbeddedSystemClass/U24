/******************************************************************************
 * $File: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_EGPRS_NS.h $
 *
 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_EGPRS_NS.h#3 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \param iRxPwr_in16dBm = Rx power in 1/16 dBm units.
   ...
   *******************************************************************************/
   ...
   This command clears event status that is used for the TM Wait For Event?function.

   This function could be called before the EDGE BER function that generates the event. For
   example, before the TM_EGPRS_BER_CONFIGURE_DL_TBF?function described in section
   ...
   *******************************************************************************/
   ...
   The user must configure a valid DL and UL TBF according to the UE multislot capability.
