/******************************************************************************
 * $File: //depot/HTE/QDART/QMSL6/inc/QMSL_Misc/QMSL_FTM_Audio.h $
 *
 ...
 ******************************************************************************
 *
 * $Header: //depot/HTE/QDART/QMSL6/inc/QMSL_Misc/QMSL_FTM_Audio.h#2 $
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   Factory Test Mode Audio, 2.4 Audio Set Path command
      ...
      to one of the vocoder PCM paths. Typical audio devices are handset, headset, and Bluetooth
      headset.

      NOTE Since some of the audio devices are eaturized,?not all audio devices are available on all
