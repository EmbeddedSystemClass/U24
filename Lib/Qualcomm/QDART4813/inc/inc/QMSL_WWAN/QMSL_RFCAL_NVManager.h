...
extern "C" {
   ...
   *******************************************************************************/
   ...
   Given an known relationship of [X,Y] of length iInLen, performs
   ...
   *******************************************************************************/
   ...
   /******************************************************************************/
   /**
   TempComp Characterized table adjustment based on the calibration temperature
   \param sQCN_Path					   [input] Stream of static QCN path
   \param iRF_Mode						   [input] RF_Mode
   \param iTempCompAdjustMeasurementType  [input] TempcompAdjust MeasurementType
