...
Program: QMSL
        ...
        $Id: //depot/HTE/QDART/QMSL6/inc/QMSL_WWAN/QMSL_FTM_GSM_RF.h#9 $

\brief Implements the "C" interface for all Factory Library functions.
...
----		   --------	   ------		-----------
1/17/2013               MRH			Adding standard comment block
...
extern "C" {
   ...
   *******************************************************************************/
   ...
   \param psGSM_V4_Cal_Params = GSM_V4_Cal_Params_Type struct containing the sweep parameters
   ...
   *******************************************************************************/
   QLIB_API unsigned char QLIB_FTM_GSM_V4_CAL( HANDLE hResourceContext, void* psGSM_V4_Cal_Params );
