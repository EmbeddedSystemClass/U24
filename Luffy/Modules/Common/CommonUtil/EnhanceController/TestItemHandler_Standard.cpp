...
CTestItemHdrStd::CTestItemHdrStd(CEnhanceController* pNextCEC) :	
CEnhanceController(pNextCEC),
m_bForcePass(false)
{
}
...
size_t CTestItemHdrStd::SetOtherParameter()
{
	...
	//this->m_pITI->SetParameterValue(ParameterKeyWord::GPPROCESSORNAME, this->m_strProcessorName.GetString());
