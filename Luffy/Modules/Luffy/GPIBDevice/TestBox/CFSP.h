...
class CFSP : public ITestBox
{
GP_DECLARE_DYNCREATE(CFSP)
public:
	CFSP(void) {}
	virtual ~CFSP(void) {}
...
// Initial functions
	...
	// Get Options of Test Device
    virtual bool GetOptions(std::string& strOptions)  { return false; }
	...
	virtual bool Preset() { return false; }
	...
	virtual bool SetGPRFGeneratorPort() { return false; }
	virtual bool SetGPRFMeasurementPort() { return false; }
	virtual bool SetCurrentMeasurementPort(std::string strFirmware) { return false; }
	virtual bool SetGPRFFixedGeneratorLoss(double dLoss) { return false; }
	...
	virtual bool SetGPRFGeneratorFrequency(unsigned int uiFrequency) { return false; }
	virtual bool SetGPRFMeasurementFrequency(unsigned int uiFrequency) { return false; }
	virtual bool SetGPRFGeneratorLevel(double dLevel) { return false; }
    virtual bool SetGPRFGeneratorOnOff(bool bOn) { return false; }
	virtual bool SetGPRFGeneratorPort(std::string strPort) { return false; }
	virtual bool SetGPRFMeasurementPort(std::string strPort) { return false; }
	...
	// GSM functions
	virtual bool SetGSMMeasurementBand (int band, bool bSig = true) { return false; }
	...
	virtual bool SetFreq_QryAtmpt(double d_Freq, std::string& strMeasured);
	virtual bool SetSweepCount(int iSwepCount);
};
