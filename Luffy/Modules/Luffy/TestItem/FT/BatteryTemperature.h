#ifndef _C_BATTERY_TEMPERATURE_H_
#define _C_BATTERY_TEMPERATURE_H_
...
class CBatteryTemperature : public ITestItem
{
GP_DECLARE_DYNCREATE(CBatteryTemperature)
...
#endif // End of #ifndef _C_BATTERY_TEMPERATURE_H_
