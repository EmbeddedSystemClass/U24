...
Program: QMSL
   ...
   $Id: //depot/HTE/QDART/QMSL6/inc/QMSL_Core.h#5 $
...
typedef unsigned char( *EfsDirCB )
   ...
   *******************************************************************************/
   QLIB_API HANDLE QLIB_QPHONEMS_ConnectServer_Sahara( unsigned int iComPort, unsigned long* version, swdlQPHONEMSCB pSWDL_QPHONEMS_CB);
