#ifndef _MY_MS_XML_H_
#define _MY_MS_XML_H_
...
typedef MSXML2::IXMLDOMDocumentPtr		XMLDoc;
typedef MSXML2::IXMLDOMNodePtr			XMLNode;
typedef MSXML2::IXMLDOMNodeListPtr		XMLNodeList;
typedef MSXML2::IXMLDOMAttributePtr		XMLAttr;
typedef MSXML2::IXMLDOMNamedNodeMapPtr	XMLAttrList;
...
public:
	...
	BOOL GetDocNum(XMLNode node, long& i_num);
	...
	***************************************************************** */
	...
	BOOL GetNodeListItem(XMLNodeList nodeList, CString& str_name, CString& str_MD5);
...
#endif // End of #ifndef _MY_MS_XML_H_
