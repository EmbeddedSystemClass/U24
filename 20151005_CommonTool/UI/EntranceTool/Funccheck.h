...
public:
	...
	bool PrCheck2(CString str_ModelProjectName, CString str_ProjectName, CString& str_ImagePath, TCHAR* sz_SO, CString str_ETVersion, TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg);
    ...
    bool DecompressFile(CString str_Toolpath, CString str_destpath, TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg);
	...
	bool RunTool(TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg, CString str_process, CString str_ProjectName, CString str_AccessoryList);
	bool ReadIniFile(CString& str_ServerPath, bool b_state);
	bool CreateBat(TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg, CString& str_batpath, CString str_process, CString str_ProjectName, CString str_AccessoryList);
    ...
    bool Entrance_Tool_Update(TCHAR * Entrance_toolver,TCHAR * sz_SO,TCHAR * sz_ErrCode,TCHAR * sz_ErrMsg);
    bool CreateUpdateBat(TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg, CString& str_batpath);
    
	bool ProjectName_Return(TCHAR* sz_modelprojList,TCHAR* sz_count,TCHAR * sz_ErrCode,TCHAR * sz_ErrMsg);
	...
	bool Query_ConsumeType(TCHAR* sz_Model, TCHAR* sz_Process, TCHAR* sz_Consume, TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg);
	bool Query_ConsumeInfo(TCHAR* sz_sn, TCHAR* sz_type, TCHAR* sz_times, TCHAR* sz_ErrCode, TCHAR* sz_ErrMsg);
...
private:
   ...
   // CString str_ETtoolVer_pre2;
	...
	CString m_str_ToolServerPath;
	CString m_str_FImageServerPath;
	CString m_str_OImageServerPath;
