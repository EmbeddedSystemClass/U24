...
void CIMEIFCDlg::ChangeGB()
{
	LogMsg(_T(" CIMEIFCDlg::ChangeGB()"));
	m_brush.CreateSolidBrush(BKGCOLOUR_FACTORY);
	m_label_info.SetBkColor(BKGCOLOUR_FACTORY);
	m_label_testItem.SetBkColor(BKGCOLOUR_FACTORY);
	m_label_ID.SetBkColor(BKGCOLOUR_FACTORY);
	m_label_NAL.SetBkColor(BKGCOLOUR_FACTORY);
	m_label_Acer22.SetBkColor(BKGCOLOUR_FACTORY);
}