...
#define DEFAULT_PC_NAME					_T("T02D01") //STATION_PREDL
#define OLDFA                           0
#define NEWFA                           1
...
/* Message between EntranceTool and UnifyUI*/
...
#define BKGCOLOUR_FACTORY		       RGB(172, 213, 121)//益眼绿(Executed by EntranceTool)//RGB(215, 240, 198)原//RGB(204, 255, 204)浅绿//RGB(204, 232, 207)豆沙绿// 
#define BKGCOLOUR_FACTORY_BAT		   RGB(226, 188, 120)//Executed by BAT
...
/*================================= Station DLL Name ==================================*/
/**
* @brief Uniform DLL name, 20140822
*/
#define	DLLNAME	_T("FactoryTool.dll")
