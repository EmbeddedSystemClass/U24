...
void CEnTabCtrl::SetAttribute()
{
	DWORD dwFlags = 0;
	dwFlags |= ETC_COLOR;
	//SetBkgndColor(RGB(215,240,198));
	EnableDraw(true ? BTC_ALL : dwFlags ? BTC_TABS : BTC_NONE); 

	CEnTabCtrl::EnableCustomLook(dwFlags | true, dwFlags);
	//Invalidate();
}
