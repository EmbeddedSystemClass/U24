...
#define _TC(x) x
	...
	public:
		...
		//20090728 Alan Tu
		//Replcae to use virtual TSTRING GetCfgVar(const TSTRING& strName,const TSTRING& strDefault) = 0;
		//For CRT issue, Defferent CRTs in VC6 and VC2005, they will cause crash when delete memory
		//Please give the buffer first befor use the API
		virtual bool GetCfgVar(const TSTRING& strName,const TSTRING& strDefault,TSTRING& strBufferValue) = 0;
