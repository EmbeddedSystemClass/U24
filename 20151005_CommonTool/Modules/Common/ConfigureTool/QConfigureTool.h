...
namespace QSYNC_LIB{	
	...
	public:
		...
		virtual bool GetCfgVar(const TSTRING& strName,const TSTRING& strDefault,TSTRING& strValue);
		...
		void* operator new( size_t nSize,LPCTSTR szConfigureTitle, LPCTSTR szFolderName);
