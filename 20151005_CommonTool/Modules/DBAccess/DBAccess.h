...
#define		 ERROR_INSERT_CONSUMEINFO_FAIL		_T("DB1081")

#define      ERROR_BADGE_INVALID              _T("DB1082")
#define      ERROR_BADGE_PN_NOMATCH           _T("DB1083")
...
DBACCESS_API bool QueryIMEIbyNAL(char * sz_NAL, char * sz_IMEI, char * sz_ErrCode, char * sz_ErrMsg);
...
// accessory usedtimes +1 and return times
DBACCESS_API bool InsertConsumeUsedTimes(char * sz_sn, char * sz_type, char * sz_usedtimes, char * sz_ErrCode,char * sz_ErrMsg);

/*Lennon add 20141020,  Add check Veneno Badge if it is valid */
DBACCESS_API bool CheckBadge_Validity(char * sz_Badge,char * sz_pn ,char * sz_ErrCode, char * sz_ErrMsg);
