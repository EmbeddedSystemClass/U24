...
interface IFacTestToolInterface : public QSYNC_LIB::INotifyBase_Char
{
	...
	/* Test sequence */
	virtual bool Begin    (int i_slot = 0) = 0;
	virtual bool PreRun   (int i_slot = 0) = 0;
	virtual bool Run      (int i_slot = 0) = 0;
	virtual bool PostRun  (int i_slot = 0) = 0;
	virtual bool Stop     (int i_slot = 0) = 0;
	virtual bool End      (int i_slot = 0) = 0;
