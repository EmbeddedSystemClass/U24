...
$Id: //depot/HTE/QDART/QMSL/QLib_Defines.h#421 $
...
#define TXLIN_NUM_TOTAL_LINEARIZERS 100
...
typedef enum
{
   ...
   LOG_EQUIP_ID_LAST_DEFAULT = LOG_EQUIP_ID_LTE,
   LOG_EQUIP_ID_MAX = 16
...
typedef enum
{
   ...
   _GPS_CMD_CODE_GPS_LINEARITY_MODE        		= 29,   //!( ' Configure CGPS Gen8 Engine Linearity mode
	_GPS_CMD_CODE_GPS_Query_GNSS_Engine_Revision = 30,																	  //!
   _GPS_CMD_CODE_GPS_DRX_MODE,                          //!( ' Not Implemented
   _GPS_CMD_CODE_GPS_DRX_ON_OFF                         //!( ' Not Implemented
...
typedef enum
{
   ...
   LOG_FTM2_LOG_TDSCDMA_AGC       = 0x1120,
   LOG_FTM2_LOG_TDSCDMA_AGC_C1    = 0x1121,
...
typedef enum
{
   ...
   _FTM_TDSCDMA_START_IDLE_MODE_REQ	= 2,
   _FTM_TDSCDMA_ACQUIRE_REQ			= 3,
   _FTM_TDSCDMA_RMC_DCH_SETUP_REQ	= 4,
   _FTM_TDSCDMA_RMC_DCH_SETUP_REQ_V2	= 5,
...
typedef enum
{
	...
	FTM_TDSCDMA_BER_IDLE_MODE_CNF			= 2,
	FTM_TDSCDMA_BER_ACQ_CNF				= 3,
	FTM_TDSCDMA_BER_CPHY_SETUP_CNF		= 4,
	FTM_TDSCDMA_PHYCHAN_ESTABLISHED_IND	= 5
...
typedef enum
{
   ...
   LOG_FTM2_TDSCDMA_START_IDLE_MODE_REQ	= 2,		//!<' FTM TDSCDMA BER start idle mode confirmation
...
/*===========================================================================*/
/**
enum for TDSCDMA non-signaling Acquisition type
*/
/*===========================================================================*/
typedef enum
{
   FTM_TDSCDMA_BER_AcqTypeFreqOnly		= 0,	//!<' Frequency valid only
   FTM_TDSCDMA_BER_AcqTypeFreqAndScrCode	= 1,	//!<' Frequency and scrambling code valid only
   FTM_TDSCDMA_BER_AcqTypeFreqScrCodePN	= 2		//!<' Frequency, scrambling code, and PN position valid
} FTM_TDSCDMA_BER_AcqType_Enum;
...
/*===========================================================================*/
/**
enum for TDSCDMA non-signaling Acquisition mode
*/
/*===========================================================================*/
typedef enum
{
   FTM_TDSCDMA_BER_AcqModeMicro	= 0,	//!<' Micro acquisition (not currently supported)
   FTM_TDSCDMA_BER_AcqModeFull	= 1		//!<' 1 = Full acquisition freq ARFCN to attempt acquisition. Required for acq_type = 0, 1, or 2.

} FTM_TDSCDMA_BER_AcqMode_Enum;
...
typedef enum
{
   FTM_TDSCDMA_BER_RMC_Type12_2kpbs				= 0,	//!<' RMC 12.2 kbps channel,
   FTM_TDSCDMA_BER_RMC_Type64kbps				= 1,	//!<' RMC 64 kbps channel,
   FTM_TDSCDMA_BER_RMC_Type384kpbs				= 2,	//!<' RMC 384 kbps channel, (Not currently supported)
   FTM_TDSCDMA_BER_RMC_Type12_2kpbs_Symmetric	= 3,	//!<' RMC 12.2 kbps channel, block size in the DL and UL is the same
   FTM_TDSCDMA_BER_RMC_Type64kbps_Symmetric		= 4,	//!<' RMC 64 kbps channel, block size in the DL and UL is the same
   FTM_TDSCDMA_BER_RMC_Type384kbps_Symmetric		= 5		//!<' RMC 384 kbps channel, block size in the DL and UL is the same
...
typedef enum
{
   FTM_TDSCDMA_BER_PCA_Type_Alg1	= 0,	//!<' Power control algorithm 1
   FTM_TDSCDMA_BER_PCA_Type_Alg2	= 1		//!<' Power control algorithm 2
} FTM_TDSCDMA_BER_PCA_Type_Enum;
...
typedef enum
{
   FTM_TDSCDMA_BER_PCA_Size_1dB	= 0,	//!<' 1dB for power control algorithm
   FTM_TDSCDMA_BER_PCA_Size_2dB	= 1,		//!<' 2dB for power control algorithm
   FTM_TDSCDMA_BER_PCA_Size_3dB = 2,   //!<' 3dB for power control algorithm
...
typedef struct
{
   ...
   byte iLNA_STATE;
   byte iPA_STATE;
   unsigned short iHDET_Raw;
   unsigned short iThemistor;
   byte iScaledThermistor;
   byte iTempCompIndex;
   byte iTempCompRemainder;
   short iHDET;//hyang todo: dup??
   short iReserved_2;
} FTM2LogMessage_TDSCDMA_AGC;
...
typedef struct
{
   ...
   */
   ...
   byte bTDSCDMA_AGChasUpdated;

   //! Storage for TDSCDMA AGC
   FTM2LogMessage_TDSCDMA_AGC oTDSCDMA_AGC;
...
/*===========================================================================*/
/**
enum for TDSCDMA non-signaling N312 parameters
*/
/*===========================================================================*/
typedef enum
{
...
/*===========================================================================*/
/**
enum for TDSCDMA non-signaling N315 parameters
*/
/*===========================================================================*/
typedef enum
{
...
typedef struct
{
   ...
   */
   ...
   for upto 16 devices that can be simulaneiously calibrated with the new cal sweep.
   */
...
#define QMSL_NV_MANAGER_COMPRESSED_VALUE_MAX_SIZE		2048
...
typedef enum
{
   ...
   BH_LTE_BAND_20,
   BH_LTE_BAND_21,
   BH_LTE_BAND_24 = LTE_BAND_ENUM_OFFSET + 24, // force this entry since it's discontinuous from previous
   BH_LTE_BAND_25,
...
typedef struct
{
	...
	unsigned short ref_chan_list[TXLIN_NUM_LINEARIZERS][TX_LINEARIZER_NUM_WAVEFORM][TXLIN_NUM_CHANNELS];
