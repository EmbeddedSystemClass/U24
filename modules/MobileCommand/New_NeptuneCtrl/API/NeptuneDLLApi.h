...
NEPDLLAPI int __stdcall P21SDCardMoveImgToDDR(int nPort, int nTimeout, char* InBuffer, size_t nInLength, char* OutBuffer);
...
NEPDLLAPI int __stdcall P21I2CTest(int nPort, int nTimeout, char* InBuffer, size_t nInLength, char* OutBuffer);
...
NEPDLLAPI int __stdcall P21BTFMGetRSSILevel(int nPort, int nTimeout, char* InBuffer, size_t nInLength, char* OutBuffer);
...
NEPDLLAPI int __stdcall P21WLANGetCmdPacketRxStatus(int nPort, int nTimeout, char* InBuffer, size_t nInLength, char* OutBuffer);
...
NEPDLLAPI int __stdcall P21FAReadVersionInfo(int nPort, int nTimeout, char* InBuffer, size_t nInLength, char* OutBuffer);
...
NEPDLLAPI int __stdcall P21GenCMDInOutTEST(int nPort, int nTimeout, char* InBuffer, size_t nInLength, char* OutBuffer);
