...
NEPDLLAPI int __stdcall QUAL_SD_CheckExternal(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F338]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_CAMERA_GetModuleId(int nPort, int nTimeout, char* OutBuffer) // cmd: 9
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F335]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_LCD_MDDIBootSplashScreen(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [L1]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_LCD_ReadTPCoordinate(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [RD]", __FUNCTION__);//QUAL_LCD_ReadTPCoordinate
}
...
NEPDLLAPI int __stdcall QUAL_LCD_ReadTPCoordinate_new(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_LCD_ReadTPCoordinate_new
}
...
NEPDLLAPI int __stdcall QUAL_LCD_ReadTPCoordinate_new_activelow(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_LCD_ReadTPCoordinate_new_activelow
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_ALSOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F380]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_ALSRead(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F380]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_Proximity(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F383]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_GSENSORReadAcc(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F381]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_InitCapSenseKey(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F384]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_ReadCapSenseKey(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F384]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_SENSOR_ECompassI2CTest(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F382]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_MODEM_GSMPowerOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F390]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_MODEM_SIMPowerOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F391]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_MODEM_GPSTest(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F392]", __FUNCTION__);;
}
...
NEPDLLAPI int __stdcall QUAL_BT_BTPowerOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F393]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_BT_FMOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F394]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_BT_BTRFTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_BT_BTRFTest
}
...
NEPDLLAPI int __stdcall QUAL_BT_TxStop(int nPort, int nTimeout, char* ErrorCode) // cmd: 13
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F393]", __FUNCTION__);//QUAL_BT_TxStop
}
...
NEPDLLAPI int __stdcall QUAL_BT_FMReadRSSI(int nPort, int nTimeout, char* InBuffer, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, InBuffer, 0, OutBuffer, " [F394]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_ReadWriteLoopTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F397]", __FUNCTION__);//QUAL_FLASH_ReadWriteLoopTest
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_ReadPage(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F397]", __FUNCTION__);//QUAL_FLASH_ReadPage
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_WritePage(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F397]", __FUNCTION__);//QUAL_FLASH_WritePage
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_ReadID(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F397]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_EraceBlock(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F397]", __FUNCTION__);//QUAL_FLASH_EraceBlock
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_FindImageStartingPage(int nPort, int nTimeout, char* InBuffer, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, InBuffer, 0, OutBuffer, " []", __FUNCTION__);//QUAL_FLASH_FindImageStartingPage
}
...
NEPDLLAPI int __stdcall QUAL_FLASH_MCPTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F397]", __FUNCTION__);//QUAL_FLASH_MCPTest
}
...
NEPDLLAPI int __stdcall QUAL_DDR_SetEBI1Clkto99MHZ(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DDR_SetEBI1Clkto99MHZ
}
...
NEPDLLAPI int __stdcall QUAL_DDR_SetEBI1Clkto128MHZ(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DDR_SetEBI1Clkto128MHZ
}
...
NEPDLLAPI int __stdcall QUAL_DDR_ReadWriteTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DDR_ReadWriteTest
}
...
NEPDLLAPI int __stdcall QUAL_DDR_ReadWriteLoopTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DDR_ReadWriteLoopTest
}
...
NEPDLLAPI int __stdcall QUAL_DDR_ReadAddr(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DDR_ReadAddr
}
...
NEPDLLAPI int __stdcall QUAL_DDR_RoughTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DDR_RoughTest
}
...
NEPDLLAPI int __stdcall QUAL_RTC_ReadYear(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F396]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_CHARGER_PreCharge(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F372]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_CHARGER_Verify_IC(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F332]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_CHARGER_ReadVersion(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F372]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_KEYPAD_Detect(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_KEYPAD_Detect
}
...
NEPDLLAPI int __stdcall QUAL_VIBRATOR_On(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F370]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_BATTERY_GAUGE_ReadTemperature(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F334]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_BATTERY_GAUGE_Reset(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F334]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_BATTERY_BatteryCoverDetect(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F385]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_DOWNLOAD_FASTBOOT_MODE(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_DOWNLOAD_FASTBOOT_MODE
}
...
NEPDLLAPI int __stdcall QUAL_DOWNLOAD_NewFlashRead(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " []", __FUNCTION__);//QUAL_DOWNLOAD_NewFlashRead
}
...
NEPDLLAPI int __stdcall QUAL_OS_JumpToAPPSBL(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " []", __FUNCTION__);//QUAL_OS_JumpToAPPSBL
}
...
NEPDLLAPI int __stdcall QUAL_WLAN_TxMaxPower(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [F395]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_LED_KeypadOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [L3]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_LED_BacklightOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [L4-C]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_LED_FlashOn(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [L7]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_ID_ReadBoardID(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F226]", __FUNCTION__);
}
...
NEPDLLAPI int __stdcall QUAL_RD_LoadAPPSBL(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_LoadAPPSBL
}
...
NEPDLLAPI int __stdcall QUAL_RD_EnterUARTPktMode(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_EnterUARTPktMode
}
...
NEPDLLAPI int __stdcall QUAL_RD_EVT0AutoTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_EVT0AutoTest
}
...
NEPDLLAPI int __stdcall QUAL_RD_SendSMEMCmd(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_SendSMEMCmd
}
...
NEPDLLAPI int __stdcall QUAL_RD_AudioAMP(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_AudioAMP
}
...
NEPDLLAPI int __stdcall QUAL_RD_ReadMemoryAddress(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [RD]", __FUNCTION__);//QUAL_RD_ReadMemoryAddress
}
...
NEPDLLAPI int __stdcall QUAL_RD_ChangeHDMIAddress(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_ChangeHDMIAddress
}
...
NEPDLLAPI int __stdcall QUAL_RD_ReadHDMIAddress(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [RD]", __FUNCTION__);//QUAL_RD_ReadHDMIAddress
}
...
NEPDLLAPI int __stdcall QUAL_RD_GetPartitionInfo(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [RD]", __FUNCTION__);//QUAL_RD_GetPartitionInfo
}
...
NEPDLLAPI int __stdcall QUAL_RD_JumpToAPPSBL_new(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_JumpToAPPSBL_new
}
...
NEPDLLAPI int __stdcall QUAL_RD_Reboot(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_Reboot
}
...
NEPDLLAPI int __stdcall QUAL_RD_Enter301Mode(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_Enter301Mode
}
...
NEPDLLAPI int __stdcall QUAL_RD_JumpToAPPSBL_WriteFlag(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_JumpToAPPSBL_WriteFlag
}
...
NEPDLLAPI int __stdcall QUAL_RD_ReadI2CStatus(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [RD]", __FUNCTION__);//QUAL_RD_ReadI2CStatus
}
...
NEPDLLAPI int __stdcall QUAL_RD_I2CStressTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_I2CStressTest
}
...
NEPDLLAPI int __stdcall QUAL_RD_GPIO7678_High(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_GPIO7678_High
}
...
NEPDLLAPI int __stdcall QUAL_RD_GPIO7678_Low(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_GPIO7678_Low
}
...
NEPDLLAPI int __stdcall QUAL_RD_LoopReadTouchCoordinate(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_LoopReadTouchCoordinate
}
...
NEPDLLAPI int __stdcall QUAL_RD_PowerDown(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_PowerDown
}
...
NEPDLLAPI int __stdcall QUAL_RD_HdmiTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_HdmiTest
}
...
NEPDLLAPI int __stdcall QUAL_RD_PictureTest(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_PictureTest
}
...
NEPDLLAPI int __stdcall QUAL_RD_RecoveryMenu(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_RecoveryMenu
}
...
NEPDLLAPI int __stdcall QUAL_RD_AutoSetEbi1KernelAddr(int nPort, int nTimeout, char* ErrorCode)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, ErrorCode, " [RD]", __FUNCTION__);//QUAL_RD_AutoSetEbi1KernelAddr
}
...
NEPDLLAPI int __stdcall QUAL_RD_ReadUartLogStatus(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [RD]", __FUNCTION__);//QUAL_RD_ReadUartLogStatus
}
...
NEPDLLAPI int __stdcall QUAL_VERSION_ReadDTVersion(int nPort, int nTimeout, char* OutBuffer)
{
	...
	return DtCmdQcom(nPort, nTimeout, command, NULL, 0, OutBuffer, " [F211]", __FUNCTION__);
}
