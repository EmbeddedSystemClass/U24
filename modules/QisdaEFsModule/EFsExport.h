...
typedef bool (*pFnEFS_WriteFile)(const char*szPort,const char *sFileSrc, const char *sFileDst);
...
typedef bool (*pFnEFS_DeleteFilesInFolder)(const char*szPort, char *szFolderPath);
