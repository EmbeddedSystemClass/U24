...
#ifndef _UnifyDLL_Detroit_WLS_H_
#define _UnifyDLL_Detroit_WLS_H_
...
#ifdef UnifyDLL_Detroit_WLS_EXPORTS
#define IDL_API extern "C" __declspec(dllexport)
#define UnifyDLL_Detroit_WLS_API extern "C" __declspec(dllexport)
#else
...
#else
UnifyDLL_Detroit_WLS_API bool __cdecl NewInterface(IFacTestToolInterface** ppIToolInterface);
...
#ifdef _ToolInterface
class CUnifyDLL_Detroit_WLS : public IToolInterface_Notify, public CNotifyBase_Char, public INotify_ANSI
#else
class CUnifyDLL_Detroit_WLS :  public IFacTestToolInterface, public CNotifyBase_Char, public INotify_ANSI
#endif
{
// Data members
public:
...
public:
	...
	CUnifyDLL_Detroit_WLS();
	virtual ~CUnifyDLL_Detroit_WLS();
...
#endif // End of #ifndef _UnifyDLL_Detroit_WLS_H_
