...
RF_IMPLEMENT_DYNCREATE(CBTWLAN_BT_4_Test)

CBTWLAN_BT_4_Test::CBTWLAN_BT_4_Test(void)
	:m_WriteCPKLog(false)
	,m_bKLossMode(false)
{
}
...
bool CBTWLAN_BT_4_Test::InitData(std::map<std::string, std::string>& paramMap)
{
	std::vector<std::string> vTmp;

	if (paramMap.find("PICSName") == paramMap.end())
	{
		TraceLog(MSG_ERROR, "Fail to find parameter PICSName for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter CommandDelay for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Frequency for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Channel for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Power for CBTWLAN_BT_4_Test");
		return false;
	}
	m_iPower = atoi(paramMap["Power"].c_str());

	if (paramMap.find("DataLength") == paramMap.end())
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Power for CBTWLAN_BT_4_Test");
		return false;
	}
	m_iDataLength = atoi(paramMap["DataLength"].c_str());
	

	if (paramMap.find("Type") == paramMap.end())
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Type for CBTWLAN_BT_4_Test");
		return false;
	}
	m_iType = atoi(paramMap["Type"].c_str());
/*
	if (paramMap.find("AdjPower") == paramMap.end())
	{
		TraceLog(MSG_ERROR, "Fail to find parameter AdjPower for CBTWLAN_BT_4_Test");
		return false;
	}
...
*/
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter RBW for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter VBW for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Span for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter TraceMode for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Detector for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter AverageTimes for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter Range for CBTWLAN_BT_4_Test");
		return false;
	}
...
bool CBTWLAN_BT_4_Test::Run(void)
{
	m_strMeasured = "";
...
bool CBTWLAN_BT_4_Test::MainFunction(void)
{
	char szTmp[256];
/*
	// Start BT power
...
*/
	if (! m_pIPhone->BTStartTxLtePower(m_iChannel, m_iDataLength, m_iType))
	{
...
bool CBTWLAN_BT_4_Test::ParseCPKItems()
{
