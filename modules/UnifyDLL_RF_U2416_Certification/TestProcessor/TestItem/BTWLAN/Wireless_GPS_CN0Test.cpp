...
bool CWireless_GPS_CN0Test::MainFunction()
{
	...
	for (int i = 0; i < m_iRetryTimes; ++i)
	{
		...
		//FactoryLog(true, "GPS", "", "", szChannel, szLower, szUpper, m_strMeasured, "", m_strMsg);
	...
	//SetPICSData ("GPS_CN0", strCN0);
	//SetPICSData ("GPS_FreqOffset", strFreqOffset);
