...
bool QuerySO_Info(char* sz_so, char* sz_model, char* sz_partNo, char* sz_soType, char* sz_errorCode, char* sz_errorMsg)
{
//	CSingleLock singleLock(&m_obj_loadADBFileCritSection, TRUE);
...
bool QueryStation_Info(char * PCname, char* sz_line, char* sz_process, char* sz_segment, char* sz_errorCode, char* sz_errorMsg)
{
...
bool InsertFAIL_data(char* sz_id, char* sz_so, char* sz_employId, char* sz_inputErrorCode, char* sz_errorCode, char* sz_errorMsg)
{
	CSingleLock singleLock(&m_obj_loadADBFileCritSection, TRUE);
...
//		CloseDB();
	...
	if ( p_recordSet -> adoEOF )
	{
		...
		sprintf(sz_errorMsg,("Get error code:%s from picsecd fail \n系统中未找到此错误代码的信息，请联系工程师"),str_Input);
//		CloseDB();
		return false;
	}
...
bool InsertPASS_data(char* sz_id, char* sz_so, char* sz_employId, char* sz_errorCode, char* sz_errorMsg)
{
	CSingleLock singleLock(&m_obj_loadADBFileCritSection, TRUE);
...
bool Insertdata_Common(char * sz_XMLname,char * sz_tablename, char* sz_errorCode, char* sz_errorMsg)
{
    CString str_sql = _T("");
...
bool InsertOOB_data(char * sz_result,char * sz_InputErrCode, char* sz_errorCode, char* sz_errorMsg)
{
...
//Eg: select * from ptbbtest where id = 'AB12345678' order by tstdate desc,tsttime desc
	...
	if (strcmp(sz_process ,"IMEI")==0) //IMEI 站ID=IMEI， L1=Picasso
	{
...
*****************************************************************************/
bool QuerySOCount_Control(char * sz_id, char * sz_so, char * sz_process, char * sz_count, char * sz_ErrCode,char * sz_ErrMsg)
{
	_RecordsetPtr p_recordSet;
	_variant_t thevalue;
...
*****************************************************************************/
bool QueryIfTestAgain(char * sz_id, char * sz_model,char * sz_process, char * sz_count,char * sz_ErrCode,char * sz_ErrMsg)
{
	_RecordsetPtr p_recordSet;
	_variant_t thevalue;
	...
	/* Sunlight add 20111221, TL/TRIGGER;FA/FALINK,VI, RUN_IN;PACKAGE still use old rule*/
	if ( (strcmp(sz_process ,"IMEI")==0) || (strcmp(sz_process ,"FCHECK")==0) || (strcmp(sz_process ,"OS_DL")==0)|| (strcmp(sz_process ,"PPIDLINK")==0)|| (strcmp(sz_process ,"FQC")==0)|| (strcmp(sz_process ,"VI")==0)||(strcmp(sz_process ,"P_VI")==0)||(strcmp(sz_process ,"FALINK")==0) || (strcmp(sz_process ,"RUN_IN")==0) || (strcmp(sz_process ,"TRIGGER")==0) || (strcmp(sz_process ,"DL")==0))
	{
...
*****************************************************************************/
bool QueryholdInfo(char * sz_id ,char * sz_model,char * sz_status,char * sz_process,char * sz_holdreas,char * sz_ErrCode, char * sz_ErrMsg)
{
	//	CSingleLock singleLock(&m_obj_loadADBFileCritSection, TRUE);
...
*****************************************************************************/
bool QueryholdInfo_V2(char * sz_id ,char * sz_model,char * sz_process,char * sz_status,char * sz_holdreas,char * sz_ErrCode, char * sz_ErrMsg)
{
	//	CSingleLock singleLock(&m_obj_loadADBFileCritSection, TRUE);
...
*****************************************************************************/
bool QueryCRHoldInfo(char * sz_picasso,char * sz_status, char * sz_ErrCode, char * sz_ErrMsg)
{
	_RecordsetPtr p_recordSet;
	_variant_t thevalue;
	CString str_sql = _T("");
...
* *****************************************************************************/
bool QueryCRHoldInfo_byMNID(char * sz_mnid,char * sz_status, char * sz_ErrCode, char * sz_ErrMsg)
{
	_RecordsetPtr p_recordSet;
	_variant_t thevalue;
	CString str_sql = _T("");
