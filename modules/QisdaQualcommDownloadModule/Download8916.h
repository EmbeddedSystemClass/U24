...
class QISDA_DOWNLOAD_CLASS_API CDownload8916 : public CDLFormatCommand, public CRefObject
{
public:
	CDownload8916(const TSTRING& str_deviceName, const std::string& str_platform = "Qualcomm8916");
	CDownload8916(int i_COMPort, CString str_multiDLFlag, const std::string& str_platform = "Qualcomm8916");
	virtual ~CDownload8916(void);
