...
#include "StdAfx.h"
#include "Download8930_autoDL.h"

CCriticalSection CDownload8930_autoDL::m_obj_loadcheckSumCritSection;

CDownload8930_autoDL::CDownload8930_autoDL(const TSTRING& str_deviceName, const std::string& str_platform)
...
CDownload8930_autoDL::CDownload8930_autoDL(int i_COMPort, CString str_multiDLFlag, const std::string& str_platform)
...
CDownload8930_autoDL::~CDownload8930_autoDL(void)
{
	if (m_p_adbDevice) 
	{
...
*****************************************************************************/
bool CDownload8930_autoDL::MultiDownload(bool b_speedUp, bool b_reOpenAfterReset, DownloadProtocol nDLPROTOCOL) 
{
	bool b_result = false;
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::Download(bool b_speedUp, bool b_reOpenAfterReset, DownloadProtocol nDLPROTOCOL) 
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::DMSSDL(void)
{
...
bool CDownload8930_autoDL::IsPathExist(const CString& path)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::StreamingDL(bool b_speedUp, DownloadProtocol nDLPROTOCOL)
{
	using namespace PLATFORM_TOOL;
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::SetFastBootFlag(void)
{
	bool b_res = false;
...
*****************************************************************************/
bool CDownload8930_autoDL::DDRTest(void)
{
	using namespace PLATFORM_TOOL;
...
* 1.0          Alex.Chen     2011/09/28          First version             
*****************************************************************************/
bool CDownload8930_autoDL::ReadDDRTestReslult(void)
{
	using namespace PLATFORM_TOOL;
...
*****************************************************************************/
bool CDownload8930_autoDL::StreamingDLIRAMLog(void)
{
	bool b_res = true;
	bool b_speedUp = false;
	char * pEnd;
...
* 1.0           Alex.Chen     2011/01/19          First version             
*****************************************************************************/
CString CDownload8930_autoDL::GetErrorCode(void) 
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
int CDownload8930_autoDL::GetComport(void)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
void CDownload8930_autoDL::SetIsOveridePartition(bool b_overridePartition)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
void CDownload8930_autoDL::SetResetMode(bool b_reset)
{
...
* 1.0           Alex.Chen     2011/01/19            First version             
*****************************************************************************/
bool CDownload8930_autoDL::SetImageFilePath(const int i_imageType, const std::string& str_filePath)
{
	bool b_res = false;
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::FastbootDownload(void)
{
...
*****************************************************************************/
bool CDownload8930_autoDL::GetOemMainVersion(CString& str_parameter)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::FastbootFlashCmd(const std::string& str_parameter)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::FastbootFormatCmd(const std::string& str_parameter)
{
	/* Check input parameter */
	if (str_parameter == _T("")) 
	{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8930_autoDL::ADBFlash(const char* sz_parmeter, const void* p_data, unsigned long long l_fileLen)
{
	/* Check input parameter */
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
void* CDownload8930_autoDL::LoadFile(const char* sz_fileName, unsigned long long* i_fileSize)
{
	/* 线程同步处理 */
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
ADBDevice* CDownload8930_autoDL::GetADBDevice(const char* sz_comPort)
{
	/* Get ADB by the COM port */
	if (m_p_adbDevice == NULL)
	{
		m_p_adbDevice = new ADBDevice(adb_class_id, 0, 0, DEVICE_INTERFACE_ID, sz_comPort, 1);
		if(m_p_adbDevice) 
		{
...
*****************************************************************************/
bool CDownload8930_autoDL::GetADB(void)
{
...
*****************************************************************************/
bool CDownload8930_autoDL::SetFTDMode(void)
{
...
*****************************************************************************/
bool CDownload8930_autoDL::Reboot(void)
{
...
* 1.0          Alex.Chen     2011/09/19             First version             
*****************************************************************************/
bool CDownload8930_autoDL::EraseSBL1(void)
{
...
bool CDownload8930_autoDL::EraseUserFat(void)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8930_autoDL::WriteCheckSum(CString str_imageFilePathName)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8930_autoDL::ReadCheckSumFile(void)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8930_autoDL::ReadFA(char* sz_FAData)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8930_autoDL::WriteFA(char* sz_FAData)
{
...
*****************************************************************************/
bool CDownload8930_autoDL::ReadFASector(int i_sectorNum, char *sz_sectorData, int i_sectorSize)
{
	bool b_speedUp = false;
...
* 1.0          Alex.Chen        2011/11/23          First version             
*****************************************************************************/
bool CDownload8930_autoDL::WriteFASector(int i_sectorNum, char *sz_sectorData, int i_sectorSize)
{
	AddMsg("Write FA.", DownloadStep::None, 100);
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8930_autoDL::BackupNVPartition(void)
{
...
bool CDownload8930_autoDL::SpiltString(CString str_sourceString, CString str_delimiter, CStringArray& stra_strArg)
{
	/* Check Input */
...
bool CDownload8930_autoDL::ADBFlashAll(const char* sz_parmeter, const char* sz_fileName)
{
	/* Check input parameter */
...
bool CDownload8930_autoDL::ExecuteFastboot(char* sz_command)
{
	/* Check input parameter */
	if ((sz_command == NULL)) 
	{
...
bool CDownload8930_autoDL::ExecuteFastbootOut(char* sz_command, CString& out)
{
	/* Check input parameter */
	if ((sz_command == NULL)) 
	{
