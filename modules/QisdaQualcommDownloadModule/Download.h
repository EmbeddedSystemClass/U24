...
public: // DMSS DL
	...
	virtual bool DMSSOpenAndWriteHexFile7K(const std::string& strHexFilePath, WORD& wAddress, int nRetryTimes = g_nRetryTimes, int nTimeout=g_nTimeout);
...
{
public:
	CDownload6240(const TSTRING& strDevice, const std::string& strPlatform = "Qualcomm6240", bool bReopenAfterReset = true);
	CDownload6240(int nCOMPort, const std::string& strPlatform = "Qualcomm6240", bool bReopenAfterReset = true);
...
public: //Setting
	...
	bool SetDSP1(const std::string& strFilePath);	
	bool SetWIN60(const std::string& strFilePath);	
	bool SetAMSS(const std::string& strFilePath);	
	bool SetAMSSHD(const std::string& strFilePath);
	bool SetAPPS(const std::string& strFilePath);	
	bool SetAPPSHD(const std::string& strFilePath);
	bool SetAPPSBOOT(const std::string& strFilePath);	
	bool SetAPPSBOOTHD(const std::string& strFilePath);
...
protected:
	...
	std::string m_strAPPS;
	std::string m_strAPPSHD;
	std::string m_strAPPSBOOT;
	std::string m_strAPPSBOOTHD;
	std::string m_strCEFS;

	std::string m_strDBL;
	std::string m_strFSBL;
	std::string m_strOSBL;
	std::string m_strDSP1;
	std::string m_strWIN60;
