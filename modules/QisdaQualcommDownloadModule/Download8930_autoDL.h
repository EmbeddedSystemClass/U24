...
* Module name	: 8930 Download   
* File name     : Download8930_autoDL.h             
* Summary       : 8930 Download (Hex DL(Qualcomm images) + Fastboot DL(Android images))                                                             
...
class QISDA_DOWNLOAD_CLASS_API CDownload8930_autoDL : public CDLFormatCommand, public CRefObject
{
public:
	CDownload8930_autoDL(const TSTRING& str_deviceName, const std::string& str_platform = "Qualcomm8260");
	CDownload8930_autoDL(int i_COMPort, CString str_multiDLFlag, const std::string& str_platform = "Qualcomm8260");
	virtual ~CDownload8930_autoDL(void);
