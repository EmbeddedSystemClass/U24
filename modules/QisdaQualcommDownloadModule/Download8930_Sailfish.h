...
* File name     : Download8930_Sailfish.h             
...
typedef enum IMAGE_TYPE_8960
{
	...
	Q8K_QGLOG	     = 20,         // Qglog
	Q8K_SAILFISH001  = 21,         // Sailfish01
	Q8K_SAILFISH002  = 22,         // Sailfish02
	Q8K_SAILFISH003  = 23,         // Sailfish03
	Q8K_SAILFISH004  = 24,         // Sailfish04
	Q8K_SAILFISH005  = 25,         // Sailfish05
	Q8K_SAILFISH006  = 26,         // Sailfish06
	Q8K_SAILFISH007  = 27,         // Sailfish07
	Q8K_SAILFISH008  = 28,         // Sailfish08
	Q8K_SAILFISH009  = 29,         // Sailfish09
	Q8K_SAILFISH010  = 30          // Sailfish10
} IMAGE_TYPE_8960;
#pragma pack()
...
class QISDA_DOWNLOAD_CLASS_API CDownload8930_Sailfish : public CDLFormatCommand, public CRefObject
{
public:
	CDownload8930_Sailfish(const TSTRING& str_deviceName, const std::string& str_platform = "Qualcomm8260");
	CDownload8930_Sailfish(int i_COMPort, CString str_multiDLFlag, CString str_toolMode, const std::string& str_platform = "Qualcomm8260");
	virtual ~CDownload8930_Sailfish(void);
...
public:
	...
	void SetErasePartitionList(std::vector<std::string> &vList) {m_vEraseList = vList;};
	void SetFormatPartitionList(std::vector<std::string> &vList) {m_vFormatList = vList;};
...
private:
	...
	ADBDevice* GetADBDevice(const char* sz_comPort, int nRetryCount);
	bool GetADB(int nRetryCount);
	bool GetADB_ReduceRetryCount(void);
...
private:
	...
	std::string  m_str_sailfish001;
	std::string  m_str_sailfish002;
	std::string  m_str_sailfish003;
	std::string  m_str_sailfish004;
	std::string  m_str_sailfish005;
	std::string  m_str_sailfish006;
	std::string  m_str_sailfish007;
	std::string  m_str_sailfish008;
	std::string  m_str_sailfish009;
	std::string  m_str_sailfish010;
...
public:
	public:
	std::vector<std::string> m_vEraseList;
	std::vector<std::string> m_vFormatList;
/*======================== Android Download =================================================================================*/
};
