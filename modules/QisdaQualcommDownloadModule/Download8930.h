...
class QISDA_DOWNLOAD_CLASS_API CDownload8930 : public CDLFormatCommand, public CRefObject
{
public:
	CDownload8930(const TSTRING& str_deviceName, const std::string& str_platform = "Qualcomm8260");
	CDownload8930(int i_COMPort, CString str_multiDLFlag, CString str_toolMode, const std::string& str_platform = "Qualcomm8260");
	virtual ~CDownload8930(void);
