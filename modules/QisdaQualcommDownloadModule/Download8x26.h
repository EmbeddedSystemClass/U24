...
class QISDA_DOWNLOAD_CLASS_API CDownload8x26 : public CDLFormatCommand, public CRefObject
{
public:
	CDownload8x26(const TSTRING& str_deviceName, const std::string& str_platform = "Qualcomm8x26");
	CDownload8x26(int i_COMPort, CString str_multiDLFlag, const std::string& str_platform = "Qualcomm8x26");
	virtual ~CDownload8x26(void);
