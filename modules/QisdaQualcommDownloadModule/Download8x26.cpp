...
CCriticalSection CDownload8x26::m_obj_loadcheckSumCritSection;

CDownload8x26::CDownload8x26(const TSTRING& str_deviceName, const std::string& str_platform)
...
CDownload8x26::CDownload8x26(int i_COMPort, CString str_multiDLFlag, const std::string& str_platform)
...
CDownload8x26::~CDownload8x26(void)
{
	if (m_p_adbDevice) 
	{
...
*****************************************************************************/
bool CDownload8x26::MultiDownload(bool b_speedUp, bool b_reOpenAfterReset, DownloadProtocol nDLPROTOCOL) 
{
	bool b_result = false;
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::Download(bool b_speedUp, bool b_reOpenAfterReset, DownloadProtocol nDLPROTOCOL) 
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::DMSSDL(void)
{
...
*****************************************************************************/
void QMSLCallBack(HANDLE hQMSLContext,
      char	*sMsg,
      unsigned short iMsgSize)
{
	...
	FILE *pFile = NULL;
	pFile = fopen("D:\\Log\\UI_RD\\QMSLCallBack.log", "wb");
...
* 1.0          Erin.Chang     2013/09/18          First version             
*****************************************************************************/
bool CDownload8x26::SAHARADL(void)
{
	using namespace PLATFORM_TOOL;
	...
	unsigned char cret;
	swdlQPHONEMSCB SWDL_QPHONEMS_CB = QMSLCallBack;
...
bool CDownload8x26::IsPathExist(const CString& path)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::StreamingDL(bool b_speedUp, DownloadProtocol nDLPROTOCOL)
{
	using namespace PLATFORM_TOOL;
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::SetFastBootFlag(void)
{
	bool b_res = false;
...
*****************************************************************************/
bool CDownload8x26::DDRTest(void)
{
	using namespace PLATFORM_TOOL;
...
* 1.0          Alex.Chen     2011/09/28          First version             
*****************************************************************************/
bool CDownload8x26::ReadDDRTestReslult(void)
{
	using namespace PLATFORM_TOOL;
...
*****************************************************************************/
bool CDownload8x26::StreamingDLIRAMLog(void)
{
	bool b_res = true;
	bool b_speedUp = false;
	char * pEnd;
...
bool CDownload8x26::GetCOMPortDevByWDK(std::map<std::string, std::string>& map_strstrCOMDevice)
{
...
bool CDownload8x26::DetectDiagPort()
{
...
bool CDownload8x26::StreamingDLeMMCLog(int nSector)
{
...
* 1.0           Alex.Chen     2011/01/19          First version             
*****************************************************************************/
CString CDownload8x26::GetErrorCode(void) 
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
int CDownload8x26::GetComport(void)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
void CDownload8x26::SetIsOveridePartition(bool b_overridePartition)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
void CDownload8x26::SetResetMode(bool b_reset)
{
...
* 1.0           Alex.Chen     2011/01/19            First version             
*****************************************************************************/
bool CDownload8x26::SetImageFilePath(const int i_imageType, const std::string& str_filePath)
{
	bool b_res = false;
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::FastbootDownload(void)
{
...
*****************************************************************************/
bool CDownload8x26::GetOemMainVersion(CString& str_parameter)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::FastbootFlashCmd(const std::string& str_parameter)
{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::FastbootFormatCmd(const std::string& str_parameter)
{
	/* Check input parameter */
	if (str_parameter == _T("")) 
	{
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
bool CDownload8x26::ADBFlash(const char* sz_parmeter, const void* p_data, unsigned long long l_fileLen)
{
	/* Check input parameter */
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
void* CDownload8x26::LoadFile(const char* sz_fileName, unsigned long long* i_fileSize)
{
	/* 线程同步处理 */
...
* 1.0          Alex.Chen     2011/01/19          First version             
*****************************************************************************/
ADBDevice* CDownload8x26::GetADBDevice(const char* sz_comPort)
{
	AddMsg("CDownload8x26 GetADBDevice Start ...", DownloadStep::None, 100);
...
*****************************************************************************/
bool CDownload8x26::GetADB(void)
{
...
*****************************************************************************/
bool CDownload8x26::SetFTDMode(void)
{
...
*****************************************************************************/
bool CDownload8x26::Reboot(void)
{
...
* 1.0          Alex.Chen     2011/09/19             First version             
*****************************************************************************/
bool CDownload8x26::EraseSBL1(void)
{
...
bool CDownload8x26::EraseUserFat(void)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8x26::WriteCheckSum(CString str_imageFilePathName)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8x26::ReadCheckSumFile(void)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8x26::ReadFA(char* sz_FAData)
{
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8x26::WriteFA(char* sz_FAData)
{
...
*****************************************************************************/
bool CDownload8x26::ReadFASector(int i_sectorNum, char *sz_sectorData, int i_sectorSize)
{
	bool b_speedUp = false;
...
* 1.0          Alex.Chen        2011/11/23          First version             
*****************************************************************************/
bool CDownload8x26::WriteFASector(int i_sectorNum, char *sz_sectorData, int i_sectorSize)
{
	AddMsg("Write FA.", DownloadStep::None, 100);
...
bool CDownload8x26::runWriteFASector(char *sz_sectorData){
...
* 1.0          Alex.Chen        2011/09/27          First version             
*****************************************************************************/
bool CDownload8x26::BackupNVPartition(void)
{
...
bool CDownload8x26::SpiltString(CString str_sourceString, CString str_delimiter, CStringArray& stra_strArg)
{
	/* Check Input */
...
bool CDownload8x26::ADBFlashAll(const char* sz_parmeter, const char* sz_fileName)
{
	/* Check input parameter */
...
/*OK 20131222 */
int CDownload8x26::fb_download_data_sparse_flush( ADBDevice*  m_p_adbDevice )
{
   // if (usb_buf_len > 0) {
	if (  m_p_adbDevice->m_usb_buf_len_ADBDevice > 0) {
...
bool CDownload8x26::ADBFlashAllLargeSize(const char* sz_parmeter, const char* sz_fileName)
{
	char sz_imgae[64] = {0};
	CString str_message;
	int64_t sz64;
...
bool CDownload8x26::ExecuteFastboot(char* sz_command)
{
	/* Check input parameter */
	if ((sz_command == NULL)) 
	{
...
bool CDownload8x26::ExecuteFastbootOut(char* sz_command, CString& out)
{
	/* Check input parameter */
	if ((sz_command == NULL)) 
	{
...
bool CDownload8x26::LoadSparseLibDLL(){
