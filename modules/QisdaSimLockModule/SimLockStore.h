#pragma once
#include "..\..\Modules\Lib\RequestUtility\InterfaceBase.h"
#include "..\..\Modules\Lib\RequestUtility\DiagCommand.h"
#include "..\..\Modules\Common\CommonUtil\ErrorCode.h"
#include "..\..\Modules\Common\CommonUtil\ErrorDefine.h"
...
public:
	...
	***************************************************************** */
	...
	bool WriteSimDataNew(DWORD iSlotId, BYTE *pSimDataBuf, int nSimDataBufLen, int nTimeout = g_nDEFAULT_SIMLOCK_Related); //[Lavernock,Melos]nSimDataBufLen=576
...
private:
	...
	BOOL StoreSimData_1024(BYTE iSlotId, BYTE iSIM_AppIdLen, BYTE* piSIM_AppId, DWORD iSIM_SecureDataLen, 
		BYTE* piSIM_SecureData, DWORD *pCmdStatus, DWORD *pStatus, int nTimeout = g_nDEFAULT_SIMLOCK_Related);

	BOOL StoreSimData_2048(BYTE iSlotId, BYTE iSIM_AppIdLen, BYTE* piSIM_AppId, DWORD iSIM_SecureDataLen, 
		BYTE* piSIM_SecureData, DWORD *pCmdStatus, DWORD *pStatus, int nTimeout = g_nDEFAULT_SIMLOCK_Related);
public:
...
// Qisda-defined QueryLockStatus command
...
public:
	...
	bool ReadSIMLockName (char* strSIMLockName);
...
// Qualcomm-defined QueryLockStatus command
class CSIM_CLASS_API CSimLockStatusEx: public CInterfaceBase
{
public:
	bool QueryLockStatus(bool *nwStatus=NULL, bool *spStatus=NULL, bool *nsStatus=NULL, bool *cpStatus=NULL, bool *simStatus=NULL);

public:
	CSimLockStatusEx(int iCOMPort);
	virtual ~CSimLockStatusEx();
};

CSIM_API bool QueryLockStatusEx(int iPort, bool *nwStatus=NULL, bool *spStatus=NULL, bool *nsStatus=NULL, bool *cpStatus=NULL, bool *simStatus=NULL);

// Qisda-defined Unlock command
...
public:
	...
	***************************************************************** */
	...
	bool TempUnlockStatus(int unlockType, char *sCode, DWORD *pStatus, int nTimeout = g_nDEFAULT_SIMLOCK_Related);
...
// Qualcomm-defined Unlock command
class CSIM_CLASS_API CSimUnLockStatusEx: public CInterfaceBase
{
public:
	bool UnlockStatus(SIMLOCKTYPE unlockType, char *szCode, DWORD *pdwStatus, int nTimeout = g_nDEFAULT_SIMLOCK_Related);

public:
	CSimUnLockStatusEx(int iCOMPort);
	virtual ~CSimUnLockStatusEx(void);
};

CSIM_API bool UnlockSIMLockEx(int iPort, SIMLOCKTYPE unlockType, char *szCode, DWORD *pdwStatus);
