...
public:
	...
	virtual bool RF_SetLevelMode(std::string strLevelMode) ;
	virtual bool RF_SetLevelMaximum(int iLevelRef) ;
	...
	virtual bool SetMaxLevelForFreErr() { return false; }
	virtual bool ResetFSP() {return false;}
	virtual bool SetBlankOFF() {return false;}
	virtual bool MaxYOffset() {return false;}
