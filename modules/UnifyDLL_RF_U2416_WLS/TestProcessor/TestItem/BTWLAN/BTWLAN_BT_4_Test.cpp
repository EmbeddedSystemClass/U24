...
bool CBTWLAN_BT_4_Test::InitData(std::map<std::string, std::string>& paramMap)
{
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter SweepTime for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter ChannelBW for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter AttenuationManual for CBTWLAN_BT_4_Test");
		return false;
	}
	...
	{
		TraceLog(MSG_ERROR, "Fail to find parameter RefLevel for CBTWLAN_BT_4_Test");
		return false;
	}
