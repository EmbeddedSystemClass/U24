#ifndef _C_BTWLAN_BT_4_TEST_H_
#define _C_BTWLAN_BT_4_TEST_H_


#include "../../../CommonUtility/BaseObject/ITestProcessor.h"

class CBTWLAN_BT_4_Test : public ITestProcessor
{
RF_DECLARE_DYNCREATE(CBTWLAN_BT_4_Test)
...
public:
	CBTWLAN_BT_4_Test(void);
	virtual ~CBTWLAN_BT_4_Test(void);
