...
public:
	...
	virtual bool RF_NPowerMeasurementMAX(int iStatistics, std::string& strMeasured) = 0 ;
	virtual bool RF_NPowerMeasurementNoOFF(int iStatistics, std::string& strMeasured) = 0 ;
	...
	virtual bool RF_SetLevelMode(std::string strLevelMode) = 0;
	virtual bool RF_SetLevelMaximum(int iLevelRef) = 0;
	...
	virtual bool SetMaxLevelForFreErr() = 0;
	virtual bool ResetFSP(void) = 0 ;
	virtual bool SetBlankOFF()=0;
	virtual bool MaxYOffset()=0;
