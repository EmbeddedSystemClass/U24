...
class CRequestLog: public CRefObject
{
...
typedef CRefObjectPtr<CRequestLog> CRequestLogPtr;
...
public:
	...
	int OpenComport(LPCTSTR lpszModelName, LPCTSTR lpszDevice,bool bRequestFunction = false);
	void CloseComport();
...
private:
	...
	std::queue<CRequestLogPtr> m_RequestLogQueue;
};
