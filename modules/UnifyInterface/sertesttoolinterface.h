...
public:
	...
	virtual size_t SetParameterValue(char* wsz_keyword, char* wsz_value) = 0;
	virtual size_t GetParameterValue(char* wsz_keyword, char* wsz_value) = 0;
 ...
 */
typedef HANDLE (__cdecl *p_fn_NewServiceInterface)();
 ...
 *   @return  If success, return true. If fail, return false.
 */
typedef void (__cdecl *p_fn_DelServiceInterface)(HANDLE hResourse);
