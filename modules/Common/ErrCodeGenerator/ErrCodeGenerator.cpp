...
/**
* @brief PreCheckMD5 was marked on 20140818 
*        because it will change the MD5.xml file and cause MD5 of local Tool is different with MD5 of server Tool
*        waste time to copy same tool every time
...
*/	
	...
	//	CString filename = 	find.GetFileName();
		...
		{       
			...
			if(Flag && str_content.GetLength()!=0)
			{
