...
class CMMIBB_KeyButtonRetryTestWindow : public CDialog
{
	DECLARE_DYNAMIC(CMMIBB_KeyButtonRetryTestWindow)

public:
	CMMIBB_KeyButtonRetryTestWindow(CWnd* pParent = NULL);   // standard constructor
	//CMMIBB_KeyButtonRetryTestWindow(int nStyle);   // standard constructor
	
	virtual ~CMMIBB_KeyButtonRetryTestWindow();
