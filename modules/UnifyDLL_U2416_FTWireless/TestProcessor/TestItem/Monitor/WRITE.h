...
#ifndef _C_Write_Proc_H_
#define _C_Write_Proc_H_
...
#define DELL_SER_TAG				"DELL_SER_TAG"


#define ADB_CMD_TIMEOUT			25000

class CWRITE : public ITestItem
{
RF_DECLARE_DYNCREATE(CWRITE)
...
private:
	...
	//bool CWRITE::GetDirectory_D_LOG_IMG()
