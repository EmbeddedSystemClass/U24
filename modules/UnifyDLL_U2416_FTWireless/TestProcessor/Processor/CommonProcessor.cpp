...
//					csTraceMsg.Format(_T("get Socket ok, cmd = %s,  cmdOut = %s, nSock_num = %d "), csCommand, cmdOut, nSock_num );
//					TraceLog(MSG_ERROR, std::string(csTraceMsg));
//					return true;
//				}
//			}
//		}
//		csTraceMsg.Format(_T("Socket is not ready, cmd = %s,  cmdOut = %s, nSock_num = %d "), csCommand, cmdOut, nSock_num );
//		TraceLog(MSG_ERROR, std::string(csTraceMsg));
//		Sleep(1000);
