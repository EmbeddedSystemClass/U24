...
namespace QSYNC_LIB 
{
	...
	typedef bool (*pFnType0013)(char* szPara1,char* szPara2,char* szPara3,char* szPara4,char* szPara5,char* szPara6,char* szPara7,char* szPara8,char* szPara9,char* szPara10,char* szPara11,char* szPara12,char* szPara13);
	...
	CFunctor::~CFunctor(void)
	{
		if(m_pISPU_CALLBACK && m_bUseCallback)
			m_pISPU_CALLBACK->Print(_T("CFunctor"),_T("EndOfCallbackFunction"));
	...
	bool CFunctor::operator()()
	{
		...
		else if(m_hProc)
		{
			...
			case 13:
				{
					pFnType0013 hProc = (pFnType0013)m_hProc;
					bRes = hProc(m_vectParameter[0],m_vectParameter[1],m_vectParameter[2],m_vectParameter[3],m_vectParameter[4],m_vectParameter[5],m_vectParameter[6],m_vectParameter[7],m_vectParameter[8],m_vectParameter[9],m_vectParameter[10],m_vectParameter[11],m_vectParameter[12]);
				}
				break;
			default:
				break;
