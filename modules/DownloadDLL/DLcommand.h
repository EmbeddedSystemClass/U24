...
typedef enum
{
	...
	Streaming_CMD_STRBUFFER_7K	= 0x20,	/* Streaming buffer command */
	Streaming_CMD_STRBUFFER_ACK_7K	= 0x09,	/* Streaming buffer response command */
	Streaming_CMD_STRBUFFERWRITE_7K	= 0x21,	/* Streaming buffer write command */
	Streaming_CMD_STRBUFFERWRITE_ACK_7K	= 0x08	/* Streaming buffer write response command */
...
typedef enum
{
	...
	OPEN_MULTI_MODE_EMMC_USER_PARTITION = 0x21,    /* eMMC partitionf                      */
