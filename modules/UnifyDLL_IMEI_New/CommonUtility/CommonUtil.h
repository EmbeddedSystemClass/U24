...
#define LogP2KPhoneCommand(msg)	CommandLog(_T(",TEST_COMMAND,"), msg)
...
public:
	UINT m_iMobileNumber; // the current working mobile number
...
class CConfigSettingCayenne: public CConfigSetting
{
public:
	CConfigSettingCayenne(){}
	virtual ~CConfigSettingCayenne(){}

	CString m_strFlashID;
	CString m_strPCBID;
	CString m_strTransceiverNum;	
};


class CConfigSettingLeopard: public CConfigSetting
{
public:
	CConfigSettingLeopard(){}
	virtual ~CConfigSettingLeopard(){}

	CString m_strFlashID;
	CString m_strPCBID;
	CString m_strTransceiverNum;	
};
class CConfigSettingSage: public CConfigSetting
{
public:
	CConfigSettingSage(){}
	virtual ~CConfigSettingSage(){}
	
	CString m_strFlashID;
	CString m_strPCBID;
	CString m_strTransceiverNum;
	CString m_strNVMBackupFilePath;
	CString m_strPanicLogFilePath;

	vector<String> m_vHSWCDMATx;
	vector<String> m_vHSWCDMARx;
	vector<String> m_vHSGSMTx;
	vector<String> m_vHSGSMRx;
	vector<String> m_vHSBaseBand;
	vector<String> m_vHSMiniFlex;
};
...
class UTimer{
    ...
    private:
        long lTimer[3];
        long lHoldDelayStart;
    protected:

    public:
        void SetTaskTimeCounter(long iTimeOut);
        void SetTaskTimeON();
        bool TaskTimeOff();
};
