...
//========================================================================== 
void UTimer::SetTaskTimeCounter(long iTimeOut)
{
    lTimer[1]=GetTickCount();
    lTimer[2]=iTimeOut;
}
//---------------------------------------------------------------------------
void UTimer::SetTaskTimeON()
{
    lTimer[0]=GetTickCount();
}
//---------------------------------------------------------------------------
bool UTimer::TaskTimeOff()
{
    bool bReturnTimeOut=false;

    if ((lTimer[0]-lTimer[1])>lTimer[2])
    {
        lTimer[1]=lTimer[0];
        bReturnTimeOut=true;
    }
    return bReturnTimeOut;
}
//---------------------------------------------------------------------------
