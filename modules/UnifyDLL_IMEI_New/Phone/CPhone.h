...
#define CPHONE_FTD_CMD_IN_OUT_CREATE_RET(cphone_func_name, dll_api_name)                  \
int CPhone::cphone_func_name(int nPort, int nTimeout, char* szInput, char* szOutput) \
{                                                                                     \
	return FTDCmdCtrl_Ret(nPort, nTimeout, dll_api_name, szInput, szOutput);              \
}
...
public:
	...
	virtual bool DetectDevice(char* szErrMsg);

	virtual bool QMSL_GetPhoneOperatingMode(unsigned long* pulPhoneMode);
	...
	int FTDCmdCtrl_Ret(int nPort, int nTimeout, char* szFuncName, char* pszInput, char* pszOutput);
	...
	bool FTD_TouchCheck(int nPort, int nTimeout, char* pszInput, char* pszOutput);//cmd:13
	...
	int FTD_OSgetprop(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_OSmodeSleep(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_ShutDown(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	...
	bool FTD_FAC_FSGProtect(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_FAC_BackupFA(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_FAC_BackupCFG(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_FAC_RestoreFA(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_FAC_RestoreCFG(int nPort, int nTimeout, char* pszInput, char* pszOutput);
	bool FTD_FAC_BackupModemCFG(int nPort, int nTimeout, char* pszInput, char* pszOutput);
