...
namespace PLATFORM_TOOL
{
	...
	class RM_CLASS_API CEFsGoldenCopyRequest  : public CDiagRequestBase
	{
	public:
		CEFsGoldenCopyRequest(bool &bSuccess);
		virtual ~CEFsGoldenCopyRequest();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CEFsSyncNVNOWaitRequest  : public CDiagRequestBase
	{
	public:
		CEFsSyncNVNOWaitRequest(DWORD &dwToken, bool &bSuccess);
		virtual ~CEFsSyncNVNOWaitRequest();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CEFsSyncNVGetStatusRequest  : public CDiagRequestBase
	{
	public:
		CEFsSyncNVGetStatusRequest(DWORD token, bool &bSuccess);
		virtual ~CEFsSyncNVGetStatusRequest();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	//HWID
	class RM_CLASS_API CReadHWIDRequestForOrange  : public CDiagRequestBase
	{
	public:
		CReadHWIDRequestForOrange(char* szHWID, bool &bSuccess);
		virtual ~CReadHWIDRequestForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
    ...
    //FA
	class RM_CLASS_API CReadFARequestForOrange  : public CDiagRequestBase
	{
	public:
		CReadFARequestForOrange(char* szOffset,char* szFA, bool &bSuccess);
		virtual ~CReadFARequestForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	//WriteFARequestForOrange
	class RM_CLASS_API CWriteFARequestForOrange  : public CDiagRequestBase
	{
	public:
		CWriteFARequestForOrange(char* szOffset,char* szFA, bool &bSuccess);
		virtual ~CWriteFARequestForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CCheckSWVersionForOrange  : public CDiagRequestBase
	{
	public:
		CCheckSWVersionForOrange(char* szFA, bool &bSuccess);
		virtual ~CCheckSWVersionForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	//CCoinCharge
	class RM_CLASS_API CCoinChargeForOrange  : public CDiagRequestBase
	{
	public:
		CCoinChargeForOrange(bool bFlag, bool &bSuccess);
		virtual ~CCoinChargeForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CBatteryChargeForOrange  : public CDiagRequestBase
	{
	public:
		CBatteryChargeForOrange(bool bFlag, bool &bSuccess);
		virtual ~CBatteryChargeForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CFileSystemBackupForOrange  : public CDiagRequestBase
	{
	public:
		CFileSystemBackupForOrange(bool &bSuccess,char* szUserData);
		virtual ~CFileSystemBackupForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CEFsBackupCheckRequest  : public CDiagRequestBase
	{
	public:
		CEFsBackupCheckRequest(bool &bIsExit);
		virtual ~CEFsBackupCheckRequest();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	class RM_CLASS_API CGoldenCopyCheckRequest  : public CDiagRequestBase
	{
	public:
		CGoldenCopyCheckRequest(bool &bSuccess, int &nStatus);
		virtual ~CGoldenCopyCheckRequest();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
		virtual void OnDataReceiver(CBufferPtr& ptBufferReceived);
	private:
		int  &m_Status; //0=success, 3=fail.
		bool &m_Success;
	};
	//Read FA Sector for Orange
	class RM_CLASS_API CReadFASectorRequestForOrange  : public CDiagRequestBase
	{
	public:
		CReadFASectorRequestForOrange(char* szOffset,char* szFA,char* szSectorSize,bool &bSuccess);
		virtual ~CReadFASectorRequestForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	//Write FA Sector for Orange   
	class RM_CLASS_API CWriteFASectorRequestForOrange  : public CDiagRequestBase
	{
	public:
		CWriteFASectorRequestForOrange(char* szOffset,char* szData,char* szSectorSize,bool &bSuccess);
		virtual ~CWriteFASectorRequestForOrange();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
	...
	//Read Coin Cell Voltage for Cairo
	class RM_CLASS_API CReadCoinCellVoltageForCairo  : public CDiagRequestBase
	{
	public:
		CReadCoinCellVoltageForCairo(char* szVoltage, bool &bSuccess);
		virtual ~CReadCoinCellVoltageForCairo();
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived)
		{
			return CDiagRequestBase::IsCompletePacket(ptBufferReceived);
		}
