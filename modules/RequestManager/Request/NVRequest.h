...
#include "..\..\SerCOMLib\CRCMachine.h"
...
namespace PLATFORM_TOOL
{
	...
	{
	public:
		CNVRequest(const WORD& NVItem, const WORD& nDIAGcmd, DIAG_NVITEM_PACKET_F_type& NVResp,bool& bSucess, const BYTE *WriteData=NULL, const size_t szWriteData=0);
	...
	private:
		...
		bool& m_bSucess;
		int m_nVersion;
		bool m_bSucess_ForTemp;
	};

    class RM_CLASS_API CClearActivationDataRequest : public CDiagRequestBase 
	{
    public:
        CClearActivationDataRequest(bool& bIsCmdSuccess,bool bNewVersion = false);
	...
	*/
	...
	//  [10/3/2010 Magan.Mei]
	class RM_CLASS_API CCheckSIMICE : public CDiagRequestBase {
	public:
		CCheckSIMICE(int* nState);
		virtual ~CCheckSIMICE();
		virtual void OnDataReceiver(CBufferPtr& ptBufferReceived);
		virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived);
		int GetState();
	private:
    ...
    {
    public:
        CReadQFuseState(unsigned long* reg1, unsigned long* reg2, unsigned long* reg3, unsigned long* reg4, unsigned long* reg5, bool* bSuccess);
    ...
    private:
        ...
        unsigned long* m_pReg3;
        unsigned long* m_pReg4;
		unsigned long* m_pReg5;
        bool* m_bSuccess;
    };
	...
	************************************************************** */
    ...
    class RM_CLASS_API CProximitySensorTestRequest : public CDiagRequestBase 
    {
    public:
        CProximitySensorTestRequest(bool& bIsCmdSuccess);
        virtual ~CProximitySensorTestRequest();
        virtual void OnDataReceiver(CBufferPtr& ptBufferReceived);
        virtual bool IsCompletePacket(CBufferPtr& ptBufferReceived);
    private:
        bool& m_bIsCmdSuccess;
