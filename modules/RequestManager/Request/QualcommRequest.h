...
namespace PLATFORM_TOOL
{
	...
	protected:
		bool Encode(const BYTE* szCommand,int nCommandLen,CBufferPtr& ptBufferSend);
		void Safememcopy(void* pBuffer, int nBufferSize,void* pData,int nDataSize);
		void PostUSBLog(CBufferPtr ptBufferSend, void* ptBufferReceived, int nExpectiveRecSize, int nGottenRecSize, TSTRING strFileName); //Post sent data and receive data.
	private:		
