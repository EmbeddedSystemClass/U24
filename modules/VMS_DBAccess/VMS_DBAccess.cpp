...
bool VMS_ConnectDB()
{
	...
	if (obj_dbAccess.ReadIniFile() != OK) {
		CString str_log;
		str_log.Format(_T("Read %s fail."), DBCONFIGFILE);
		DBLOG(str_log);
		return false;
	}
	...
	try {
		...
		if (SUCCEEDED(hr)) {
			...
			str_connect += _T("User ID=VMS;");
			str_connect += _T("Password=vms#2011;");
...
//		  str_sql = _T("select * from VRCM where img_version ='")+str_FactoryImageVer+_T("' and [5e_PN] ='") +str_PN+_T("'and tool_version ='")+ str_ToolVerison+_T("' order by timestamp desc");
		  str_sql = _T("select * from VRCM where img_version ='")+str_FactoryImageVer+_T("' and [5e_PN] ='") +str_PN+_T("'and tool_version ='")+ str_ToolVerison+_T("' order by id desc");
	  }
	  else
	  {
//		  str_sql = _T("select * from VRCM where img_version ='")+str_FactoryImageVer+_T("' and [5g_PN] ='") +str_PN+_T("' and tool_version ='")+ str_ToolVerison+_T("' order by timestamp desc");
		  str_sql = _T("select * from VRCM where img_version ='")+str_FactoryImageVer+_T("' and [5g_PN] ='") +str_PN+_T("' and tool_version ='")+ str_ToolVerison+_T("' order by id desc");
	  }
...
//	  str_sql = _T("select * from VRCM where img_version ='")+str_FactoryImageVer +_T("' and OS_version ='") +str_OSImageVer +_T("' and [9JCS_PN] ='") +str_PN+_T("' and tool_version ='")+ str_ToolVerison+_T("' order by timestamp desc");
 	  str_sql = _T("select * from VRCM where img_version ='")+str_FactoryImageVer +_T("' and OS_version ='") +str_OSImageVer +_T("' and [9JCS_PN] ='") +str_PN+_T("' and tool_version ='")+ str_ToolVerison+_T("' order by id desc");
  }
  else
  {   
	  return false;
