...
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_BT_INQUIRY, "FTD_BT_INQUIRY")
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_BT_MAC, "FTD_BT_MAC")
...
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_WLAN_MODULE_Test, "FTD_WLAN_MODULE_Test")
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_WLAN_MAC, "FTD_WLAN_MAC")
...
//22-HDCP
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_HDCPKEY, "FTD_HDCPKEY")
...
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_Check_APQ_UART, "FTD_Check_APQ_UART")
CPHONE_FTD_CMD_IN_OUT_CREATE(FTD_DDCRX, "FTD_DDCRX")
