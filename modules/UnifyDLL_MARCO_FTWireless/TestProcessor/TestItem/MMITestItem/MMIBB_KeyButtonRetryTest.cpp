...
#include "stdafx.h"
#include "MMIBB_KeyButtonRetryTest.h"


RF_IMPLEMENT_DYNCREATE(CMMIBB_KeyButtonRetryTest)

CMMIBB_KeyButtonRetryTest* pButtonTest;

bool CMMIBB_KeyButtonRetryTest::PreRun()
{
	m_strResult = "-";
	m_strItemCode = "-";
	m_strBand = "-";
...
bool CMMIBB_KeyButtonRetryTest::PostRun()
{
	return true;
}

bool CMMIBB_KeyButtonRetryTest::InitData(std::map<std::string, std::string>& paramMap)
{
	...
	{
		TraceLog(MSG_ERROR, "Failed to Get XMLTimeOut for class CMMIBB_KeyButtonRetryTest");
		return false;
	}
	...
	{
		TraceLog(MSG_INFO, "Fail to find parameter RetryTime for CMMIBB_KeyButtonRetryTest");
		return false;
	}
	return true;
}

bool CMMIBB_KeyButtonRetryTest::Run()
{
	bool passFail = false;
...
bool CMMIBB_KeyButtonRetryTest::runLoop_SideKeyTest()
{
	m_i_retriedTime = 0;
	CString cs_TestTime;
...
bool CMMIBB_KeyButtonRetryTest::runLoop_HeadsetKeyTest()
{
	m_i_retriedTime = 0;
	CString cs_TestTime;
	char sz_pattern[FTD_BUF_SIZE] = {0};
...
bool CMMIBB_KeyButtonRetryTest::getButtonCount()
{
	bool b_res;
...
bool CMMIBB_KeyButtonRetryTest::getSideKey()
{
	bool b_Res_Cmd;
...
bool CMMIBB_KeyButtonRetryTest::getSideKeyProcess()
{
	bool b_Stop = true;
...
int CMMIBB_KeyButtonRetryTest::getButtonCountProcess()
{
	bool b_res = false;
	b_StopkKeyTest = false;
	int nCount;
...
UINT CMMIBB_KeyButtonRetryTest::AfxBounceWindowThread(LPVOID pParam)
{
	pButtonTest = (CMMIBB_KeyButtonRetryTest*)pParam;
...
bool CMMIBB_KeyButtonRetryTest::InitialBounceWindow(int nStyle)
{
	pButtonWindow = new CMMIBB_KeyButtonRetryTestWindow;
	...
	KeyTestThreadHandle = AfxBeginThread(CMMIBB_KeyButtonRetryTest::AfxBounceWindowThread, this, THREAD_PRIORITY_NORMAL, 0, 0, NULL);
...
bool CMMIBB_KeyButtonRetryTest::EndButtonTestDlg()
{
...
bool CMMIBB_KeyButtonRetryTest::showMsg(char* szMsg)
{
