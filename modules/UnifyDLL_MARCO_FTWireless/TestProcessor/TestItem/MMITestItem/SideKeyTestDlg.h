...
class CDublin2KeyTestDlg : public CDialog
{
	DECLARE_DYNAMIC(CDublin2KeyTestDlg)

public:
	CDublin2KeyTestDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CDublin2KeyTestDlg();
