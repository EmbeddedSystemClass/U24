...
ISRV_API int SetCallBackRxResult(HANDLE hResource, int(*CallBack)(const char*))
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());

	CServiceToolController* pSTController = (CServiceToolController*)hResource;
	pSTController->SetCallSendRxResult(CallBack);
	return NO_ERROR;
}
...
: m_strCurrentStation(_T("")), nTestItemIndex(9999), bProcessResult(true)
{
	...
	else if (QISDA_MODULE_NAME == "WIFI TX")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR] = this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Left(this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReverseFind('\\'));
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Append(_T("\\Module\\RF_Certification\\RF\\TX\\"));
	}
	else if (QISDA_MODULE_NAME == "WIFI RX")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR] = this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Left(this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReverseFind('\\'));
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Append(_T("\\Module\\RF_Certification\\RF\\RX\\"));
	}
	else if (QISDA_MODULE_NAME == "WIFI TX CW WAVE")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR] = this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Left(this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReverseFind('\\'));
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Append(_T("\\Module\\RF_Certification\\RF\\CW\\"));
	}
	else if (QISDA_MODULE_NAME == "2G4 TX")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR] = this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Left(this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReverseFind('\\'));
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Append(_T("\\Module\\QC1\\RF\\2G4TX\\"));
	}
	else if (QISDA_MODULE_NAME == "WIFI 5G TX")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR] = this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Left(this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReverseFind('\\'));
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Append(_T("\\Module\\RF_Certification\\RF\\5G_TX\\"));
	}
	else if (QISDA_MODULE_NAME == "WIFI 5G RX")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR] = this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Left(this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReverseFind('\\'));
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].Append(_T("\\Module\\RF_Certification\\RF\\5G_RX\\"));
	}
	else if (QISDA_MODULE_NAME == "WIFI 5G TX CW WAVE")
	{
		this->m_Parametermap[ParameterKeyWord::STATIONNAME] = this->m_strCurrentStation = STATION_BTWLAN;
		GetModuleFileName(NULL, this->m_Parametermap[ParameterKeyWord::WORKINGDIR].GetBufferSetLength(MAX_PATH+1), MAX_PATH);
		this->m_Parametermap[ParameterKeyWord::WORKINGDIR].ReleaseBuffer();
...
void CServiceToolController::SetCallSendRxResult(LPVOID pfunc)
{
	m_fpSendRxResult = (RxResultCallBack)pfunc;
}

void CServiceToolController::SendRxResult(const char* szMeasured)
{
	if (m_fpSendRxResult != NULL)
	{
		m_fpSendRxResult(szMeasured);
	}
}
...
void CServiceToolController::Event(const char* str_event, long nParam)
{
	...
	if (strcmp(str_event, UI_ITEM) == 0)
	{
		...
		for (int i = 0; i < m_vTestItemList.size(); i++)
		{
	...
	if (strcmp(str_event, UI_RESULT) == 0)
	{
		...
		if(nTestItemIndex < m_vTestItemList.size())
		{
			...
			SendRxResult(p_st_uiResult->sz_measured);
